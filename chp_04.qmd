...
with pm.Model() as model_mlb:
    ...
    μ = pm.Deterministic("μ", α + β0 * bikes.temperature + β1 * bikes.hour)
    _ = pm.NegativeBinomial("y_pred", mu=np.exp(μ), alpha=σ, observed=bikes.rented)
