...
Now notice that all circles looks very similar to each other and than any two circles with the same value of $r$ are essentially the same objects. Thus we can think of The Family of Circles, where each member is set apart from the rest precisely by the value of $r$.
